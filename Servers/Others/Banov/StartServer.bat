...
SET "MODS=P:\Mods\@Banov;"

:: ====================================================================================================================
::  NO NEED TO MODIFY ANYTHING ELSE, UNLESS YOU KNOW WHAT YOU'RE DOING!!!
:: ====================================================================================================================
SET "CLIENTLOGSDIR=%PROJECTDIR%\Servers\!ClientDiagLogs"
SET "MISSIONDIR=%PROJECTDIR%\Missions\Custom\empty.banov"
SET "SERVERCFG=%PROJECTDIR%\Servers\Others\Banov\serverDZ.cfg"
SET "PROFILES=%PROJECTDIR%\Servers\Others\Banov\Profiles"
