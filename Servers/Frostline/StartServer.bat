...
SET "MISSIONDIR=%PROJECTDIR%\Missions\Vanilla\dayzOffline.sakhal"
SET "SERVERCFG=%PROJECTDIR%\Servers\Frostline\serverDZ.cfg"
SET "PROFILES=%PROJECTDIR%\Servers\Frostline\Profiles"
